...
@AllArgsConstructor
/**
 * Compares this month's CSAT average against last month's and produces a direction (UP/DOWN/STABLE).
 * Exposed on the manager dashboard via {@link CSATMetricsDTO#getTrend()}.
 */
