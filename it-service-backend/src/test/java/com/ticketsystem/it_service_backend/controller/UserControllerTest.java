...
class UserControllerTest {
    ...
    void getAllUsers_returnsAllDtos() {
        ...
        when(userService.getUsersFiltered(null, null, false, 0, 20)).thenReturn(page);

        ResponseEntity<java.util.Map<String, Object>> response = userController.getAllUsers(null, null, false, 0, 20);
