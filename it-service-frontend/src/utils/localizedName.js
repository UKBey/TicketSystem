...
/**
 * Bilingual (tr/en) name helpers for products and ticket topics.
 *
 * The API returns both variants (`nameTr`/`nameEn`, `productNameTr`/`productNameEn`,
 * `topicNameTr`/`topicNameEn`); the UI shows the variant matching the active
 * language and falls back to the other one when it is empty.
 */
