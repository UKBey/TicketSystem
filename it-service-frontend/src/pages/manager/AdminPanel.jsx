...
export default function AdminPanel() {
  ...
  return (
    <>
      ...
      <div data-tour="admin-access" className="rounded-xl border overflow-hidden" style={{ backgroundColor: 'var(--bg-surface)', borderColor: 'var(--border-color)', boxShadow: 'var(--shadow-sm)' }}>
