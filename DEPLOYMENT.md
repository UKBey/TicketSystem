...
LDAP_ADMIN_PASSWORD, LDAP_CUSTOMER_PASSWORD, LDAP_AGENT_PASSWORD,
LDAP_AGENT_ADMIN_PASSWORD, LDAP_MANAGER_PASSWORD
...
# DELETE /actuator/caches/{name} 200 dönmeli AGENT_ADMIN/MANAGER rolü ile
```
